...
## How it works?
Firstly, it chooses the variability, one random (randint) value between 1 and 20. The variability is only applied to the consonants and will be the distance between the real letter and the coded letter. e.g., if the letter "b" was written with the variability 1, in the coded message a "c" will appear instead.<div>
